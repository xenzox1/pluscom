"use strict";
var precacheConfig = [["/admin/index.html", "07ff5de25fb24f14777884ae8461a16e"], ["/admin/static/css/main.c17080f1.css", "302476b8b379a677f648aa1e48918ebd"], ["/admin/static/js/main.db23f30e.js", "98954649e2bdbf52556d5cbc382cc90f"], ["/admin/static/media/logo.5d5d9eef.svg", "5d5d9eefa31e5e13a6610d9fa7a283bb"]],
  ...
  if ("GET" === t.request.method) {
    var e,
        ...
        r = "index.html";(e = urlsToCacheKeys.has(n)) || (n = addDirectoryIndex(n, r), e = urlsToCacheKeys.has(n));var a = "/admin/index.html";!e && "navigate" === t.request.mode && isPathWhitelisted(["^(?!\\/__).*"], t.request.url) && (n = new URL(a, self.location).toString(), e = urlsToCacheKeys.has(n)), e && t.respondWith(caches.open(cacheName).then(function (e) {
